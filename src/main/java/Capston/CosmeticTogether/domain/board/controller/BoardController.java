...
public class BoardController {
    ...
    //TODO 댓글도 같이 리턴해야 함
    @GetMapping("/{boardId}")
    @Operation(summary = "[API] 게시글 단일 조회", description = "해당 게시글의 boardId를 URL 경로에 포함시켜 하나의 게시글 정보를 조회합니다. "
    ...
    @Operation(summary = "[API] 팔로잉 게시글 조회", description = "사용자가 팔로잉한 사용자의 최신 게시글들(List)을 리턴합니다")
